...
COMMON_ARGS=(
	...
	"KCFLAGS=-w -D__ANDROID_COMMON_KERNEL__ -DCONFIG_ARM_SMMU_MODULE=1 -DCONFIG_CFG80211_MODULE=1 -DCONFIG_QCOM_IOMMU_UTIL_MODULE=1 -DCONFIG_QCOM_VA_MINIDUMP_MODULE=1 -DCONFIG_SCHED_WALT_MODULE=1"
)
